...
def page_name(candidate_name):
    candidates = get_names(get_candidates_by_name(candidate_name))
    quantity = int(len(candidates))
    return render_template('search.html', quantity=quantity, candidates=candidates)
...
def page_skill(skill_name):
    ...
    quantity = int(len(candidates))
    return render_template("skill.html", quantity=quantity, candidates=candidates, skill_name=skill_name)
